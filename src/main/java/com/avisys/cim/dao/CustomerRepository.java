...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
	 ...
	 * findByFirstNameContainingIgnoreCaseAndLastNameContainingIgnoreCaseAndMobileNumber(
	 * String firstName, String lastName, String mobileNumber);
	 */

	public List<Customer> findByFirstNameContainingIgnoreCaseOrLastNameContainingIgnoreCaseOrMobileNumber(
			String firstName, String lastName, String mobileNumber);
